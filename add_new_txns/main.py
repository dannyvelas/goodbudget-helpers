...
from add_new_txns.match import only_both_txns
from add_new_txns.match import only_ch_txns
...
for new_ch_txn in new_ch_txns:
    answer_if_should_add = input(f'Adding {new_ch_txn.title}, {new_ch_txn.amt}:')
