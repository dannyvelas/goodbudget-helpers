...
- Python 3.14.3 (system), venv at `.venv/` + `python-dotenv` (`dotenv_values`), `pytest 9.0.2` (007-main-config-ynab)
- Input: `./in/chase.csv`, `./in/ynab.csv`; Output: `./out/<timestamp>/` (007-main-config-ynab)
...
## Recent Changes
- 007-main-config-ynab: Added Python 3.14.3 (system), venv at `.venv/` + `python-dotenv` (`dotenv_values`), `pytest 9.0.2`
